...
sudo mkdir -p ~/hadoopdata/hdfs/{namenode,datanode}
...
sudo chown hadoop:hadoop -R /home/hadoop/hadoop/*
sudo chown hadoop:hadoop hadoop/logs
sudo chmod 777 hadoopdata/hdfs/datanode/
sudo chmod 777 hadoopdata/hdfs/namenode/
